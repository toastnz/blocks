...
class BlockTablesMigrationTask extends BuildTask
{
    ...
    protected $title = 'Block Tables Migration';

    protected $description = 'Migrate Block "TableName" to "Blocks_TableName"';
    ...
    public function createTables($table = false) {
        ...
        $insert = SQLInsert::create('"Blocks_' . $table . '"');
